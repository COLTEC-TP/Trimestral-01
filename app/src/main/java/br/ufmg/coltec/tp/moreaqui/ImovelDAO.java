...
public class ImovelDAO {
    ...
    public ArrayList<Imovel> filtrarImoveis(String nome) {
        ...
        for(int i=0; i < instance.imoveis.size(); i++){
            if(instance.imoveis.get(i).getNome().toLowerCase().contains(nome.toLowerCase())){
                imoveisFiltrados.add(instance.imoveis.get(i));
            }
        }
